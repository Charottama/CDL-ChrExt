...
//I use alert on several part to show how this could be work - mong
...
$(document).ready(function () {
	if (disabled) {
		...
		//this part mostly shows ads so we might not be able to delete all - charott
		...
		//products page sch directory - charott
		...
		//myb directory only for watchlist and will work when log in as ebay user - charott
...
//to work with button 
//not working as prefer yet but can reload the page - ivan
